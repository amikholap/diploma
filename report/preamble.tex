...
% Зачем: Подпись ссылок на рисунки вида "рисунок/формула Х"
\addto\extrasrussian{%
...
\addto\captionsrussian{%
  ...
  % Зачем: Ручная локализация заголовков листингов.
...
\usepackage{siunitx}
\sisetup{binary-units = true, output-decimal-marker = {,}, per-mode = symbol}
