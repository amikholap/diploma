...
\FPeval{\inputLoc}{100}
\FPeval{\inputLocCorrected}{60}
\FPeval{\preprocessLoc}{520}
\FPeval{\preprocessLocCorrected}{520}
\FPeval{\ioLoc}{2700}
\FPeval{\ioLocCorrected}{700}
\FPeval{\fileMaintenanceLoc}{520}
\FPeval{\fileMaintenanceLocCorrected}{580}
\FPeval{\fileProcessingLoc}{750}
\FPeval{\fileProcessingLocCorrected}{300}
\FPeval{\fileCreationLoc}{1100}
\FPeval{\fileCreationLocCorrected}{500}
\FPeval{\exceptionLoc}{430}
\FPeval{\exceptionLocCorrected}{430}
\FPeval{\componentIntegrationLoc}{730}
\FPeval{\componentIntegrationLocCorrected}{730}
\FPeval{\utilityLoc}{460}
\FPeval{\utilityLocCorrected}{280}
\FPeval{\externalDeviceLoc}{6850}
\FPeval{\externalDeviceLocCorrected}{2680}
\FPeval{\scienceLoc}{8370}
\FPeval{\scienceLocCorrected}{3500}

\FPeval{\totalLoc}{clip(\inputLoc + \preprocessLoc + \ioLoc + \fileMaintenanceLoc + \fileProcessingLoc + \fileCreationLoc + \exceptionLoc + \componentIntegrationLoc + \utilityLoc + \externalDeviceLoc + \scienceLoc)}
\FPeval{\totalLocCorrected}{clip(\inputLocCorrected + \preprocessLocCorrected + \ioLocCorrected + \fileMaintenanceLocCorrected + \fileProcessingLocCorrected + \fileCreationLocCorrected + \exceptionLocCorrected + \componentIntegrationLocCorrected + \utilityLocCorrected + \externalDeviceLocCorrected + \scienceLocCorrected)}
...
\FPeval{\machineTimeCostExact}{ clip( \oneHourMachineTimeCost * \totalLocCorrected / 100 * \adjustedTimeToDebugCodeNormative ) }
...
Оценка стоимости создания ПО со стороны разработчика предполагает составление сметы затрат, которая включает следующие статьи расходов \cite{palycin_2006}:
\begin{itemize}
...
Уточненный объём ПО~---~\SI{\totalLocCorrected}{\text{LoC}}. 
...
Согласно данным, приведенным в производственном календаре для пятидневной рабочей недели в 2013 году для Беларуси~\cite{belcalendar_2015}, фонд рабочего времени составит
\begin{equation}
